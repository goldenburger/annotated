...
GROUPS = {
    ...
    'extension': ['ext_all', 'ext_post', 'e_p3', 'narrow', 'ext_pod', 'ext_welcome', 'ext_float', 'ext_r9', 'ext_x', 'ext_r12',
                  'ext_r13', 'hl', 'store_up', 'fp_unwrap', 'x_quote', 'x_fold', 'x_emoji', 'reinject', 'feedtabs', 'podguess', 'snappref', 'penpref', 'follows', 'stroke', 'delall', 'postquote', 'btnplace', 'strokelive', 'strokelines'],
